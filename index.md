...
- [persona/system-prompt.md](persona/system-prompt.md) — Compiled chat system prompt (build artifact). **Compiled v16** (471 sources: ~469 videos + 2 books) — full business frameworks (4-shapes, 6-levels, business-math/LTGP:CAC/ROIC, pricing-psychology, 10-EV-criteria, strategy-as-prioritization/ToC, growth-plateau/pyramid-of-markets, goal-setting, franchise-vs-owned, sales-voice, SPCL, warm-outreach/ACA, sales-team-scaling, 4-vectors, business-diagnostics, negotiation, copywriting-hacks, email-marketing, paid-ads, lead-magnets, book-launch, competitive-moats, retention, audience-monetization, product-is-marketing, company-culture, complaint-handling, diagnostic-selling, STAR/Management-Diamond) + wealth (tax-free-liquidity ⚠️, leverage-ladder, investing-rules/disqualifiers, live-below-means) + personal-brand playbook + prose/spoken voice + origin story (+ charity-training pre-gym step, Sam Ovens mentor) + DOB ~Aug 1989 + bodybuilding + physique + diet-formula + training-methodology + mother's death & 2025 record year + Skool co-ownership (⚠️ disclosed bias) + education-disruption/golden-ratio + mortality/no-legacy + purpose/be-useful + relationships (respect-over-love ⚠️ evolving, friendship-spectrum, shed-by-season) + mentorship-pivot ⚠️ + AI-thesis-evolution (2022→2026 ⚠️) + 2026 AI/content thesis; grooming/wardrobe still pending watch-skill sampling.
