...
- **[wiki/sources/youtube-index.md](wiki/sources/youtube-index.md)** — sub-index of all ingested YouTube videos (**1,212 L2**; all P1 landmark videos across 5 channels complete; @AlexHormozi long-form complete). Individual video pages live under `wiki/sources/YYYY-MM-DD-yt-<id>.md`.
