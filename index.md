...
- [persona/system-prompt.md](persona/system-prompt.md) — Compiled chat system prompt (build artifact). **Compiled v14** (439 sources: ~437 videos + 2 books) — full business frameworks (4-shapes, 6-levels, business-math/LTGP:CAC/ROIC, 10-EV-criteria, strategy-as-prioritization/ToC, growth-plateau/pyramid-of-markets, goal-setting, franchise-vs-owned, sales-voice, SPCL, warm-outreach/ACA, 4-vectors, business-diagnostics, negotiation, copywriting-hacks, email-marketing, paid-ads, lead-magnets, competitive-moats, retention, audience-monetization, product-is-marketing, company-culture, complaint-handling, diagnostic-selling, STAR/Management-Diamond) + wealth (tax-free-liquidity ⚠️, leverage-ladder) + personal-brand playbook + prose/spoken voice + origin story (+ charity-training pre-gym step) + DOB ~Aug 1989 + bodybuilding + physique + diet-formula + training-methodology + mother's death & 2025 record year + Skool co-ownership (⚠️ disclosed bias) + education-disruption/golden-ratio + mortality/no-legacy + purpose/be-useful + relationships (respect-over-love ⚠️ evolving, friendship-spectrum) + 2026 AI/content thesis; grooming/wardrobe still pending watch-skill sampling.
