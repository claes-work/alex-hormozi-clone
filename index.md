...
_Last updated: 2026-07-08 (first book ingest: $100M Money Models + Affiliate Black Book)_
...
- **[wiki/sources/youtube-index.md](wiki/sources/youtube-index.md)** — sub-index of all ingested YouTube videos (**598 L2**; all P1 landmark videos across 5 channels complete; @AlexHormozi 2018–2021 origin-era P1/P2 underway). Individual video pages live under `wiki/sources/YYYY-MM-DD-yt-<id>.md`.
...
- [wiki/topics/business/business.md](wiki/topics/business/business.md) — Offers, leads, sales, scaling, money models, pricing, retention.
  - [money-model](wiki/topics/business/money-model.md) — the umbrella framework: sequence of offers, three stages, build order, Gym Launch case study.
  ...
  - [sales-team-scaling](wiki/topics/business/sales-team-scaling.md) — building a sales team from 0: interview screens, 14-day onboarding, team CLOSER + coaching loop, PIP management.
  ...
  - [competitive-moats](wiki/topics/business/competitive-moats.md) — the 13 legal moats (network effects, scale, IP, M&A, distribution) — building a monopoly.
  - [retention](wiki/topics/business/retention.md) — revenue-retention > logo, leaky bucket, onboarding/expectations, tenure thresholds, member success.
  ...
  - [company-culture](wiki/topics/business/company-culture.md) — culture = founder's values dripping down; values as decision filters; Acquisition.com's three values.
  - [complaint-handling](wiki/topics/business/complaint-handling.md) — "a refund is only an apology"; the angry boat; tragic-to-magic; the box of responsibility.
...
- [wiki/topics/wealth/wealth.md](wiki/topics/wealth/wealth.md) — Investing, net-worth philosophy, spending.
  ...
  - [tax-free-liquidity](wiki/topics/wealth/tax-free-liquidity.md) — the ultra-rich playbook: 4 leverage tiers + tax-free liquidity (buy-borrow-die, ESOPs). ⚠️ self-reported, not financial advice.
...
- [wiki/topics/content-strategy/content-strategy.md](wiki/topics/content-strategy/content-strategy.md) — His own media playbook: platforms, formats, hooks, volume.
  ...
  - [book-writing-and-launch](wiki/topics/content-strategy/book-writing-and-launch.md) — his self-publish playbook: ~1,000 hrs/8 drafts, word-of-mouth launch, free/low-price spread ($100M Offers → 200k+ copies).
...
- [persona/beliefs.md](persona/beliefs.md) — Core frameworks, values, opinions — dated & cited (**78 sources**); enriched from the topic pages + P2 synthesis (perfect-business 5-filter, wealth 4-paths, 4-shapes, 6-levels risk ladder, tiered pricing, biz-math benchmarks, lead-magnets, TAM, fat-pitch, maximizer, trust=punishability, LTV:CAC, competitive-moats, focus-superpower, Skool/education-disruption + golden-ratio [⚠️ ownership bias], hundred-golden-BBs, tax-free-liquidity, culture-values, complaint-handling, mortality/no-legacy, 5-levels-of-competence, diagnostic-selling, purpose/be-useful, respect-over-love [⚠️ evolving], prep-is-skill, losses-are-tuition, product-first, 2026 AI thesis) with tracked evolutions (net-worth→Goodwill, business-first→marriage-first).
...
- [persona/system-prompt.md](persona/system-prompt.md) — Compiled chat system prompt (build artifact). **Compiled v17** (495 sources: ~493 videos + 2 books) — full business frameworks (4-shapes, 6-levels, business-math/LTGP:CAC/ROIC, pricing-psychology, 10-EV-criteria, strategy-as-prioritization/ToC, growth-plateau/pyramid-of-markets, goal-setting, franchise-vs-owned, sales-voice, SPCL, warm-outreach/ACA, sales-team-scaling, 4-vectors, business-diagnostics, negotiation, copywriting-hacks, email-marketing, paid-ads, lead-magnets, book-launch, competitive-moats, retention, audience-monetization, product-is-marketing, company-culture, complaint-handling, diagnostic-selling, STAR/Management-Diamond) + wealth (tax-free-liquidity ⚠️, leverage-ladder, investing-rules/disqualifiers, live-below-means, reinvest-was-a-mistake ⚠️, idea-vs-execution-risk) + personal-brand playbook + prose/spoken voice + origin story (deep father story, quit-at-23 mortality decision, charity-training pre-gym step, Sam Ovens mentor, spending-seasons arc) + DOB ~Aug 1989 + bodybuilding + physique + diet-formula + training-methodology + mother's death & 2025 record year + Skool co-ownership (⚠️ disclosed bias) + education-disruption/golden-ratio + mortality/no-legacy + purpose/be-useful + don't-follow-feelings + relationships (respect-over-love ⚠️ evolving, friendship-spectrum, shed-by-season) + mentorship-pivot ⚠️ + AI-thesis-evolution (2022→2026 ⚠️) + 2026 AI/content thesis; grooming/wardrobe still pending watch-skill sampling.
