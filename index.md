...
_Last updated: 2026-07-19 (Drive ingest COMPLETE: $100M Offers + Leads books + Lost Chapters + all 12 playbooks + Scaling Roadmap + 2 bonus chapters + Leila SOPs context; fresh-upload batch 276 (@AlexHormozi 2 + @MoreMozi 4); 2,206 L2 videos; synthesis pass 29 (+ inline-L3 $100M library), system-prompt v37; new topic: hiring-and-recruiting)_
...
- **[wiki/sources/youtube-index.md](wiki/sources/youtube-index.md)** — sub-index of all ingested YouTube videos (**2,206 L2**; all P1 landmark videos across 5 channels complete; @AlexHormozi, @ACQofficial, @TheSkoolSchool, and @GymLaunch long-form complete (@AlexHormozi re-drained 2026-07-19); only @MoreMozi long-form remains). Individual video pages live under `wiki/sources/YYYY-MM-DD-yt-<id>.md`.
