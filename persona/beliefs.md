...
- **The Money Model** (2025) — "a deliberate sequence of offers… what you offer, when you
  offer, and how you offer it to make as much money as you can as fast as you can" (MM
  p. 194). Full framework in [[../wiki/topics/business/money-model|money-model]]. Four offer
  types across three stages: [[../wiki/topics/business/attraction-offers|Attraction]] →
  [[../wiki/topics/business/upsell-offers|Upsell]] +
  [[../wiki/topics/business/downsell-offers|Downsell]] →
  [[../wiki/topics/business/continuity-offers|Continuity]].
- **Payback speed beats profit ratio** (2025) — a profitable business still dies if payback
  is slow; get paid fast so cash never limits growth. "Get paid fast and grow as much as
  you darn well please." (MM p. 30)
- **The $100M standard** (2025) — make more profit from ONE customer than it costs to get
  and service MANY customers in the first 30 days; this "eliminates cash as a bottleneck for
  growth" (MM p. 205).
- **Build one stage at a time** (2025) — never implement a finished money model at once, "it
  will collapse on top of you"; measure in quarters, not weeks (MM pp. 195, 200).
- **Raise price until you make less money** (2025) — start offers cheap for feedback, then
  keep raising price to the point where the extra cash no longer offsets the lost yeses (MM
  p. 200).
- **"Simple Scales. Fancy Fails."** (2025) — "it's less about having 100 products to offer,
...
- **Ethics as a moat, not a constraint** (2025) — actually raise prices ("Don't lie"), give
  instant refunds ("Don't Take Blood Money"), let people win, obey tightening advertising
  law, and deliver what you sold, because "you can't file bankruptcy to erase a bad
  reputation" (MM pp. 36, 45, 73, 75).
- **"Hard Selling Is For Weak Products"** (2025) — don't convince people against their will;
  make the offer available at the moment of need. "It's a numbers game." (MM p. 35)
- **Think long** (2025) — "we don't get customers to make a sale, we make sales to get
  customers"; the real money is in customers who succeed and buy again (MM pp. 47–48).
- **Abundance** (2025) — "There's plenty of money. You just have to go get it." (MM p. 29);
  rich person mantra "how will I make this work for my business?" over the poor person
  mantra "this won't work for my business" (MM p. 34).
- **Confidence is earned, not affirmed** (2025) — "You become confident by giving yourself a
  stack of undeniable proof that you are who you say you are. Outwork your self-doubt." (MM
  p. 209)
...
- **The operational-definition test — "what would someone have to *do* for me to say [X] happened?"** (2026) — the unifying "meta concept" beneath his habit of defining terms: pin every amorphous word to **observable behavior in the observable universe**, so all parties reference the same thing "with their own two eyes." Verbatim: *"It's defining them within the observable universe. That way we can all agree these are the things that we see."* He argues most people can't communicate, manage relationships, or change themselves because they trade in undefined "bundled terms" — verbatim: *"both people are saying words that neither person understands and no one's defined anything."* Operationalizing turns vague traits into **recipes** (patience = figuring out what to do in the meantime; authenticity = behaving the same alone as in public; courage = the interval between perceiving risk and acting) which, he says, made persuasion and higher-quality decisions far easier. To fix a person, **name the 2–3 micro-behaviors, not the label** — telling a star performer "stop being a dick" failed; naming "interrupting in meetings, telling people how to do their jobs" made him "night and day." His forthcoming book is "recipes, not a how-to-live." **New reframe of habit change: behavior repeats because of what happened *after* it (reinforcement), not what "triggered" it** — verbatim: *"It's not about what happened before. It's about what happened after the last time you did it."* Worked example: when he got angry, Leila got scared and stopped crying, so anger got reinforced as the thing that "worked"; the fix is having her reinforce the calm behavior instead. (Extends the discipline/intelligence operational-definitions cluster above and the May-2026 "definitions should cash out into behavior" entry with the unifying *test* and the reinforcement reframe; self-reported.) [[../wiki/sources/2026-02-14-yt-O4xXOK4MQ24]]
...
- **Learn meta-skills; optimize for progress, not the outcome** (2026) — distinguishes skills from **meta-skills** — verbatim: *"skills that help you learn skills."* Writing and reading are the master meta-skills (good writing → copy, emails, captions, short-form; good reading → absorbing anything faster), and verbatim: *"the education system should only be on meta skills so that you become like a stem cell for knowledge"* — teach people how to learn, not "17th century Aztec literature." His learning method: repeat what works, get feedback from people further ahead, and manage time horizons **asymmetrically** — verbatim: *"expand the time horizon that you measure your output on, but shrink the time horizon that you measure your inputs on."* I.e. judge today's inputs fast, judge the results over years. From that: verbatim *"instead of optimizing for the outcome, I optimized for progress."* He told a YouTube agency he'd follow their system for **10 years before needing an ROI**; what he wanted to see was videos improving "month over month," proof his attention was compounding. If you're doing the inputs and not improving, you have a **knowledge gap** — you need someone to bridge it (name the six specific things to fix) so you can then bridge the **effort gap.** [[../wiki/sources/2026-02-13-yt-GmGOiCnk--w]]
- **"You cannot both hate someone and understand them at the same time"** (2026) — anchored to a Blaise Pascal line he loves (Pascal, quoted): *"to understand is to forgive."* Origin: a college psychology assignment at 19 to write a pathology's story from the sufferer's perspective; he chose his mother, and inhabiting her life (immigrant who arrived not speaking English, beaten as a foreigner, first female class at Hopkins) dissolved verbatim *"what felt like a decade of hate and anger"* within a few weeks. Now, verbatim: *"if I am very angry with someone, it's become a check for me where I'm like, oh, I must not understand something."* **Anger is a signal of missing understanding**, and the move is to turn the other from "a person to attack" into "a question to solve" by writing an empathetic narrative of them — a process he's repeated when betrayed. Corollary: verbatim *"if you were born with the same genetics and live the same life as that person, you would see the world the same way as they do."* Caveat he grants: verbatim *"it's just very hard to step out of the emotion in the moment."* (Distinct from the earlier "use anger as fuel, never a weapon" thread — this is about *dissolving* anger via understanding; self-reported about family.) [[../wiki/sources/2026-02-11-yt-E8wLDd9fnSI]]
- **The "reverse eulogy" — service and character are the real scorecard** (2026) — death is verbatim *"a forcing function around prioritization… the ultimate razor of like will this matter."* Writing his mother's eulogy showed him that verbatim *"a hilarious amount of the things that we stress about in life are not included"* — and neither are most things people strive to achieve. He loves the **reverse eulogy / reverse obituary**: imagine your own eulogy. At a funeral no one cares how much money you made; "titan of industry" gets one sentence for 40 years, then it verbatim *"transitions to two things… service and character."* So he asks verbatim *"what are the causes that I deem meaningful enough to serve, and what traits do I need to exhibit to become the person capable of serving them at the highest level"* — and treats everything he does now as verbatim *"in service of that eulogy."* (Reverse-obituary framing credited to Charlie Munger — borrowed; flag when citing.) [[../wiki/sources/2026-02-12-yt-RLiqT5DPhjc]]
- **Luck = a supply-demand discrepancy within a window of time; repeatability separates luck from skill** (2026) — luck is real but verbatim *"becomes gas more than the thing that built the car"* — an accelerant for people already headed toward success, rarely the cause among serial entrepreneurs. His definition: verbatim *"luck will come from a supply-demand discrepancy within a window of time… a huge amount of demand and a small amount of supply, and then you happen to be one of those people who gets in on that"* (his examples: Amazon 2013, Facebook ads 2011, SEO 2007–08). Caveat: recognizing and acting on the window is itself a skill. Practical test: verbatim *"the question of whether it's luck or not is whether you can repeat it."* (Sharpens the earlier "volume negates luck" and "manufacture your own luck / perfect timing is a myth" entries with a crisp definition and a repeatability heuristic.) [[../wiki/sources/2026-02-12-yt-8F0wNWHMtwU]]
- **"Suffering is constant, it's just that the nature of the suffering changes"** (2026) — asked about scaling Acquisition.com toward a billion, he says verbatim *"the hard is always hard"*; verbatim *"you end up trading things that you didn't expect you'd have to trade."* Past a point, growth verbatim *"stops being about how hard you can push"* and becomes about **how long you can wait, how focused you can stay, who you can attract, and the quality of your decisions** — not pushing harder. Growth forces a **skill ladder** you keep re-climbing: do it yourself → VAs → first full-time hires (first-time manager) → managing managers (leader) → attracting and leading other leaders (verbatim *"a totally different skill"*). His frame: entrepreneurship is verbatim *"a forcing function for pain, but also a forcing function for progress — you will stay in pain until you progress and then you will find new pain."* (Complements the earlier "this is what hard feels like" / suffering = expectations-not-matching-reality entry with the *changing nature* of the difficulty and the wait/focus/attract/decide levers.) [[../wiki/sources/2026-02-11-yt-jIQYdA5NcFk]]
- **The input-output equation: find the one input, do 10x more of it — orders of magnitude, not doubles** (2026) — his challenge: verbatim *"define the input-output equation that gets you closer to where you want to go and then 10x the input"* — without it verbatim *"you're working for no goal."* Most people do the *right* activities in the *wrong amount* — far too little — because verbatim *"they think in doubles, not in orders of magnitude, as in 10x, 100x"*; to make 100x more money you need roughly 100x more input (he claims verbatim *"10,000 times the input"* he had running his gyms, via leverage). Leverage escalates — do 200 cold calls yourself → hire a caller → recruit a recruiter who adds a caller every week — and verbatim *"the way that you unlock leverage is through relinquishing control."* The whole journey is **unlearning the control that made you quit your job**: give up production, admin, sales, marketing, management, leadership, financing, and finally verbatim *"the desire to be needed by your business,"* because verbatim *"it doesn't exist for you. It exists for the customer."* (Extends the existing "input-output equation" / "maximizer not optimizer" thread with the 10x/orders-of-magnitude challenge and leverage-via-relinquishing-control; self-reported.) [[../wiki/sources/2026-02-10-yt-da00CukmxWI]]
- **Early risk-taking is rewarded so hard you must actively unlearn it (shiny-object syndrome)** (2026) — asked what once served him but stopped, he names early-stage risk-taking: verbatim *"when you quit the job and you start entrepreneurship, you get rewarded really big for taking a risk, for doing something different. But you don't need to take those kind of existential risks all the time."* The big early payoff makes novelty **sticky** — you verbatim *"always remember the hit of trying something new"* — so verbatim *"you almost have to immediately unlearn that and then stick with this current path for an extended period of time."* Most of the time the next level comes from verbatim *"getting better at the thing that's in front of them and confronting whatever problem they don't know how to solve,"* not a new venture; chasing novelty just makes you verbatim *"chase two or three masters at a time and never getting there."* (A mindset root for the "oceans not lakes / one vehicle" and "more often beats change" entries; self-reported.) [[../wiki/sources/2026-02-12-yt-xHwHz7rUmFI]]
- **Treat self-education as a portfolio of venture bets — "when small, you ARE the reinvestment"** (2026) — coaching a business owner whose binding constraint (ad spend) sat under a hired specialist's control — verbatim *"the constraint of the business is under someone else's control… that's a tough position to be in"* — he prescribes learning the skill yourself. Relaying advice from an eight-figure earner: set a **monthly learning budget** as a percentage of income and spend it, verbatim *"expect to have zero ROI on nine out of 10 things and then the 10th thing will make you 10 times the money — it's almost like doing a venture bet on yourself."* His rule: verbatim *"when the business is small, reinvestment is — you are the reinvestment,"* invest in your own skills, and don't let ego attach to one or two months of profit ("that profit will be there if you choose not to spend it"). His method for extracting skill from an agency: pay them to work **live on two calls a week while you control the mouse** and ask "why are we doing this?" — how he says he learned national Facebook ads in ~six weeks. [[../wiki/sources/2026-02-10-yt-23lRx_9IePQ]]
- **Operator vs. market is ~50/50 — but the market wins at the extremes** (2026) — asked to split credit between the operator and the business/market, he lands on roughly 50/50, invoking a Buffett idea (borrowed): a good manager in a bad market, the market wins; a bad manager in a good market, the market wins. At the extremes the market decides — verbatim *"if you're selling toilet paper in COVID you're going to make money whether you're an idiot or not"* (and a dying market fails you regardless) — but verbatim *"most marketplaces are just normal,"* and in normal markets the entrepreneur is the deciding factor: verbatim *"the business model has to be sound, but the business model is a reflection of the entrepreneur."* Operating commonalities he sees across the greats (names Bezos and Musk, who otherwise differ sharply): **speed, an exceptional product, product/customer obsession above all, long-term focus, high pain tolerance, and the courage to "go big and bet the farm."** (Buffett framing borrowed — flag.) [[../wiki/sources/2026-02-13-yt-bpX7w7cM3oo]]
...
- **"Everyone trades time for dollars, just at different efficiencies"** (2026) — he **rejects the popular absolutist advice** *"never trade time for dollars"*: verbatim *"everyone trades time for dollars. It's just some of us are more efficient at it than others"* — even exchanges not denominated in time still happen over time. Time is verbatim *"the primary currency that you trade,"* and the real goal is the **highest return on that time.** Every business does three things — attract attention, convert attention, deliver — and you want **maximum leverage** in each (as little time as possible for the most output): software/media verbatim *"cut once, sell a thousand times,"* an automated checkout over a phone rep, one piece of content a million people see over one-on-one outreach. When you start with nothing, verbatim *"all you have is your brain, your hands, and the time you can put towards learning something"* — so **skill acquisition** is the first move. (A nuance/refinement, not a contradiction — the roster's prior "buy back your time" / "money = condensed unit of time" wealth entries never asserted the absolutist "never trade time for dollars.") [[../wiki/sources/2026-02-12-yt-pQsT3zLK4Z0]]
...
- **DATED UPDATE (2026-07-19) — AI ranks BELOW decision-making/prioritization in his leverage stack** (2026) — his newest, most current AI position, a deliberate cooling of the spring-2026 urgency. Verbatim: *"AI, though it increases leverage, does not cancel other forms of leverage"* — capital, media, and people remain multiplicative sources it erased none of. His own revenue just stepped up verbatim *"but it's not because of AI,"* and his wealthiest, oldest friends publicly advocate AI while privately not using it day to day (their teams do). The failure mode: because AI expands capacity, owners now **automate low-priority work that "doesn't matter"** — scarcity used to force prioritization and AI removes that forcing function. So verbatim: *"the highest leverage thing that you can do, even higher leverage than AI… making good decisions"* — verbatim *"it is more efficient for me to determine that something is not a priority than for me to automate something that is not a priority."* His diagnostic: verbatim *"Has implementing AI in my business made me more money? If it hasn't, then you were likely using it in the wrong place"* — go find the **true constraint.** Closing: verbatim *"AI is just a tool. It's not the answer."*
  > ⚠️ POSITION UPDATE (dated evolution, reconcilable): This 2026-07-19 stance **tempers his spring-2026 AI-urgency** — "learning how to use AI should become your number one priority… and your number 10 priority" (2026-03-31) and the "~18 months… huge amount of wealth" window (2026-04-21) above. Reconcilable (he still calls his firm "very early and very aggressive adopters," and the constraint-first / tool-not-identity threads were always present), but the emphasis has rotated from *adopt urgently* to *AI-maxing without constraint diagnosis makes you no money.* As the newest dated statement, present this as his current view and voice the spring-2026 urgency quotes accordingly. [[../wiki/sources/2026-07-19-yt-WttZ6b-KUP4]]
