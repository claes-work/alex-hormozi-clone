...
USAGE
    ...
    python tools/synthesis_batch.py prepare --scope MoreMozi   # filter the debt/notes by a keyword
...
def main() -> None:
    ...
    pp.add_argument("--scope", help="filter the Synthesis-notes lines by a keyword (e.g. MoreMozi)")
    args = p.parse_args()
