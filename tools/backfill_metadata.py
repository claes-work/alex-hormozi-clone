...
Usage:
  python tools/backfill_metadata.py --channel @AlexHormozi          # backfill + rerank
  python tools/backfill_metadata.py --channel @AlexHormozi --top 50 # P1 = top 50 by views
  python tools/backfill_metadata.py --channel @AlexHormozi --batch 40
"""
import argparse
import csv
import subprocess
